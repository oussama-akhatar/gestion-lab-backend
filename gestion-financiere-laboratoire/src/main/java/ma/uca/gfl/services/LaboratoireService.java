...
public class LaboratoireService {
    ...
    @Autowired
    public LaboratoireService(LaboratoireRepository laboratoireRepository) {this.laboratoireRepository = laboratoireRepository;}

    public Laboratoire addLaboratoire(Laboratoire laboratoire){return laboratoireRepository.save(laboratoire);}

    public List<Laboratoire> findAllLaboratoires(){
        return laboratoireRepository.findAll();
    }

    public Laboratoire updateLaboratoire(Laboratoire etablissement){return laboratoireRepository.save(etablissement);}
